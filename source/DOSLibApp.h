...
{
    OdString function_name;
    _AdsFuncPtr adsFunc;
};
typedef std::vector<AdsFunctionDef> AdsFunctionDefs;
...
public:
    ...
    static AdsFunctionDefs createAdsFuncs();
    static CDOSLibApp* getInstance();
...
private:
    bool m_onLoadDwgOnce = false;
    static inline AdsFunctionDefs sAdsFuncs = createAdsFuncs();
    static inline CDOSLibApp* sModuleInstance = nullptr;
